...
<form method = "POST" action = mission_5_1_3.php>
...
<input id="pass" type = "password" name = "password" value ="<?php if(!empty($pass)){echo $pass;}?>"  placeholder = "<?php if(empty($pass)){echo "パスワード";}?>">
...
<input id="pass" type = "password" name = "editpass"  placeholder = "パスワード">
